...
//----------------------
extern void set_start_line(byte line)
{
...
//----------------------
extern void goto_col(unsigned int x)
{
   byte pattern;
   CONTROLPORT &= ~DI;	//DI low --> command
   CONTROLPORT &= ~RW;	//RW low --> write
...
//----------------------
extern void goto_row(unsigned int y)
{    
   byte pattern;
   CONTROLPORT &= ~DI;	//DI low --> command
   CONTROLPORT &= ~RW;	//RW low --> write
...
//------------------------
extern void glcd_clrln(byte ln)
{
    int i;
...
//-----------------------   
extern byte glcd_read(byte column)
{
...
//-----------------------
extern void point_at(unsigned int x,unsigned int y,byte color)
{
    byte pattern = 0;
    goto_xy(x,(int)(y/8));  
    switch (color)
...
//-----------------------
extern void h_line(unsigned int x,unsigned int y,byte l,byte s,byte c)
{
    int i;
...
//-----------------------
extern void v_line(unsigned int x,unsigned int y,signed int l,byte s,byte c)
{
    unsigned int i;
...
//-----------------------
extern void line(unsigned int x1,unsigned int y1,
...
//-----------------------
extern void rectangle(unsigned int x1,unsigned int y1,
               unsigned int x2,unsigned int y2,
               byte s,byte c)
{
...
//-----------------------
extern void cuboid(unsigned int x11,unsigned int y11,
...
//-----------------------
extern void h_parallelogram(unsigned int x1,unsigned int y1,
                     unsigned int x2,unsigned int y2,
...
//-----------------------
extern void v_parallelogram(unsigned int x1,unsigned int y1,
                     unsigned int x2,unsigned int y2,
                     byte l,byte s,byte c)
{
    v_line(x1,y1,l,s,c);
...
//-----------------------
extern void h_parallelepiped(unsigned int x11,unsigned int y11,
...
//-----------------------
extern void v_parallelepiped(unsigned int x11,unsigned int y11,
                      unsigned int x12,unsigned int y12,byte l1,
                      unsigned int x21,unsigned int y21,
                      unsigned int x22,unsigned int y22,byte l2,
                      byte s,byte c)
...
//-----------------------
extern void circle(unsigned int x0,unsigned int y0,
...
//--------------------------
extern void enlarge(char *large,unsigned char c,byte size)
{
	byte i,j,temp;
	byte k = 0;
	for(i=0;i<size;i++)
...
//--------------------------
extern void putItSz(int c,int x,int y,byte sz)
{
  byte i,j,k;
  char large[8][sz];
  goto_col(x);
...
//--------------------------
extern void glcd_putchar(byte c,int x,int y,byte l,byte sz)
{
    if(l == 1)
    {
    	//if(c == 129) c = 250;
...
//--------------------------
extern void glcd_puts(char *c,int x,int y,unsigned char l,byte sz,signed char space)
{
   char i = 0;
   char special = 0;
...
//------------BMP Display--------------------
extern void bmp_disp(byte *bmp,unsigned int x1,unsigned int y1,
                         unsigned int x2,unsigned int y2)
{
    unsigned int i,j;    
    for(i=y1;i<=y2;i++)
